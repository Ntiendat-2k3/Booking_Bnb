        ...
        <div className="grid gap-8 mt-6 lg:grid-cols-3">
          <div className="space-y-8 lg:col-span-2">
            ...
            >
              ...
              <div className="grid gap-3 mt-3 sm:grid-cols-2">
                {reviews.slice(0, 6).map((rv) => (
                  <div key={rv.id} className="p-4 border rounded-2xl">
                    <div className="flex items-center gap-2">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src={
                          rv.reviewer?.avatar_url || "https://i.pravatar.cc/150"
                        }
                        alt=""
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-1 text-xs text-slate-600">
                          <StarIcon className="w-3 h-3 text-slate-900" />
                          <span>{rv.rating}</span>
                        </div>
                      </div>
                    </div>
            ...
            >
              ...
              <div className="flex items-center justify-center h-64 mt-4 overflow-hidden border rounded-2xl bg-slate-50 text-slate-600">
          ...
          <aside className="p-5 bg-white border shadow-sm h-fit lg:sticky lg:top-28 rounded-2xl">
            ...
            <button
              className="w-full px-4 py-3 mt-4 text-sm font-semibold text-white rounded-xl bg-rose-500 hover:bg-rose-600 disabled:opacity-60"
              disabled
            ...
            <p className="mt-3 text-xs text-slate-600">
              Sprint 2: giao diện + hiển thị dữ liệu. Sprint 3 mới làm đặt
              phòng/thanh toán.
            </p>
          </aside>
        </div>
