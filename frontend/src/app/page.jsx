    ...
    <div className="space-y-3">
      ...
      <div className="rounded-lg border p-4 space-y-2">
        ...
        <ul className="list-disc pl-5 text-slate-700">
          ...
          <li>
            <code className="rounded bg-slate-100 px-1">GET /api/v1/auth/google</code>
          </li>
          <li>
            <code className="rounded bg-slate-100 px-1">POST /api/v1/auth/refresh</code>
          </li>
          <li>
            <code className="rounded bg-slate-100 px-1">POST /api/v1/auth/logout</code>
          </li>
          <li>
            <code className="rounded bg-slate-100 px-1">GET /api/v1/auth/profile</code>
          </li>
        </ul>
      </div>
    </div>
