...
export default function LoginPage() {
  ...
  const googleUrl = process.env.NEXT_PUBLIC_GOOGLE_AUTH_URL || "http://localhost:3000/api/v1/auth/google";
  ...
  return (
    <div className="mx-auto max-w-md space-y-4">
      ...
      <form onSubmit={onSubmit} className="space-y-3 rounded-lg border p-4">
        ...
        <button disabled={status==="loading"} className="w-full rounded-md bg-slate-900 px-3 py-2 text-white disabled:opacity-60">
